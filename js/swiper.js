...
!(function(e, t) {
  ...
  const c = {
    ...
    hasClass: function(...e) {
      const t = l(e.map(e => e.split(" ")));
      return (
        o(this, e => t.filter(t => e.classList.contains(t)).length > 0).length >
        0
      );
    },
        ...
        F({
          ...
          setTranslate: () => {
            ...
            if (
              ...
              if (p)
                h.transform(
                  `translate3d(0px, ${i / 2 + c.shadowOffset}px, ${-i /
                ...
                const e = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                  ...
                  i = c.shadowOffset;
                h.transform(
                  `scale3d(${s}, 1, ${a}) translate3d(0px, ${r / 2 +
                    i}px, ${-r / 2 / a}px) rotateX(-90deg)`
                );
              }
